...
//  Netflix Clone
//
//  Created by Yüksel Baltacıoğlu on 12.11.2023.
//
...
class TitleTableViewCell: UITableViewCell {
    ...
    private let playButtonView: UIButton = {
        let button = UIButton()
    ...
    private func applyConstraints(){
        ...
        let playButtonConstraints = [
            playButtonView.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: -15),
